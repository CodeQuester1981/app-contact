  ...
  <nav class="flex justify-between items-center mb-4">
    <ul class="flex space-x-6 mr-6 text-lg">
      ...
      <li class="mx-5 float-right">
          @csrf    
            <button type="submit">
              <a href="/people/create"><i class="fa-solid fa-circle-user"></i> Create Contact</a>
            </button>
      </li>
      <li class="mx-5 float-right">
        @csrf    
          <button type="submit">
            <a href="/blog/create"><i class="fa-solid fa-robot"></i> Create a Blog Post with ChatGPT</a>
          </button>
      </li>
      <li class="mx-5 float-right">
        @csrf    
          <button type="submit">
            <a href="/blogs"><i class="fa-solid fa-blog"></i> View Blog Post</a>
          </button>
      </li>
      @else
      <li class="p-3">
